...
var file_file_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x1a, 0x0a, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc9,
	...
	0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x66, 0x69, 0x6c, 0x65, 0x2e,
	...
	0x01, 0x0a, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x2d, 0x0a, 0x07, 0x41, 0x70, 0x70, 0x4c, 0x69,
	0x73, 0x74, 0x12, 0x0d, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65,
	0x71, 0x1a, 0x11, 0x2e, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x41, 0x70, 0x70, 0x4c, 0x69, 0x73, 0x74,
	...
	0x1a, 0x0d, 0x2e, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x41, 0x70, 0x70, 0x49, 0x74, 0x65, 0x6d, 0x22,
	0x00, 0x12, 0x31, 0x0a, 0x11, 0x41, 0x70, 0x70, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x0d, 0x2e, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x41, 0x70,
	...
	0x2e, 0x49, 0x64, 0x52, 0x65, 0x71, 0x1a, 0x12, 0x2e, 0x66, 0x69, 0x6c, 0x65, 0x2e, 0x41, 0x70,
	0x70, 0x52, 0x65, 0x73, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x3b, 0x0a, 0x12,
	0x69, 0x6f, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x62, 0x61, 0x2e, 0x66, 0x69,
	0x6c, 0x65, 0x42, 0x09, 0x66, 0x69, 0x6c, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
	0x18, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x62, 0x61, 0x2f,
	0x73, 0x70, 0x65, 0x63, 0x2f, 0x66, 0x69, 0x6c, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_file_proto_goTypes = []interface{}{
	(*AppItem)(nil),      // 0: file.AppItem
	(*AppListResp)(nil),  // 1: file.AppListResp
	(*AppResetResp)(nil), // 2: file.AppResetResp
	(*base.ListReq)(nil), // 3: base.ListReq
	(*base.IdReq)(nil),   // 4: base.IdReq
	(*base.Empty)(nil),   // 5: base.Empty
}
var file_file_proto_depIdxs = []int32{
	0, // 0: file.AppListResp.items:type_name -> file.AppItem
	3, // 1: file.file.AppList:input_type -> base.ListReq
	4, // 2: file.file.AppDetail:input_type -> base.IdReq
	0, // 3: file.file.AppUpdateOrCreate:input_type -> file.AppItem
	4, // 4: file.file.AppDelete:input_type -> base.IdReq
	4, // 5: file.file.AppReset:input_type -> base.IdReq
	1, // 6: file.file.AppList:output_type -> file.AppListResp
	0, // 7: file.file.AppDetail:output_type -> file.AppItem
	5, // 8: file.file.AppUpdateOrCreate:output_type -> base.Empty
	5, // 9: file.file.AppDelete:output_type -> base.Empty
	2, // 10: file.file.AppReset:output_type -> file.AppResetResp

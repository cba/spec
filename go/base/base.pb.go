...
type Map struct {
	...
	Data map[string]string `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` //数据
}
...
var file_base_proto_rawDesc = []byte{
	...
	0x03, 0x4d, 0x61, 0x70, 0x12, 0x27, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x13, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x4d, 0x61, 0x70, 0x2e, 0x44, 0x61,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x3e, 0x0a, 0x12, 0x69, 0x6f, 0x2e, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x62, 0x61, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x42, 0x09, 0x42, 0x61,
	0x73, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x1b, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_base_proto_goTypes = []interface{}{
	...
	(*Map)(nil),     // 3: base.Map
	nil,             // 4: base.Map.DataEntry
}
var file_base_proto_depIdxs = []int32{
	4, // 0: base.Map.data:type_name -> base.Map.DataEntry

...
var file_auth_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x1a, 0x0a, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc9,
	...
	0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e,
	...
	0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x2d, 0x0a, 0x07, 0x41, 0x70, 0x70, 0x4c, 0x69,
	0x73, 0x74, 0x12, 0x0d, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65,
	0x71, 0x1a, 0x11, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x41, 0x70, 0x70, 0x4c, 0x69, 0x73, 0x74,
	...
	0x1a, 0x0d, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x41, 0x70, 0x70, 0x49, 0x74, 0x65, 0x6d, 0x22,
	0x00, 0x12, 0x31, 0x0a, 0x11, 0x41, 0x70, 0x70, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x0d, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x41, 0x70,
	...
	0x2e, 0x49, 0x64, 0x52, 0x65, 0x71, 0x1a, 0x12, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x41, 0x70,
	0x70, 0x52, 0x65, 0x73, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x3e, 0x0a, 0x12,
	0x69, 0x6f, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x62, 0x61, 0x2e, 0x61, 0x75,
	...
	0x73, 0x70, 0x65, 0x63, 0x2f, 0x67, 0x6f, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_auth_proto_goTypes = []interface{}{
	(*AppItem)(nil),      // 0: auth.AppItem
	(*AppListResp)(nil),  // 1: auth.AppListResp
	(*AppResetResp)(nil), // 2: auth.AppResetResp
	(*base.ListReq)(nil), // 3: base.ListReq
	(*base.IdReq)(nil),   // 4: base.IdReq
	(*base.Empty)(nil),   // 5: base.Empty
}
var file_auth_proto_depIdxs = []int32{
	0, // 0: auth.AppListResp.items:type_name -> auth.AppItem
	3, // 1: auth.Auth.AppList:input_type -> base.ListReq
	4, // 2: auth.Auth.AppDetail:input_type -> base.IdReq
	0, // 3: auth.Auth.AppUpdateOrCreate:input_type -> auth.AppItem
	4, // 4: auth.Auth.AppDelete:input_type -> base.IdReq
	4, // 5: auth.Auth.AppReset:input_type -> base.IdReq
	1, // 6: auth.Auth.AppList:output_type -> auth.AppListResp
	0, // 7: auth.Auth.AppDetail:output_type -> auth.AppItem
	5, // 8: auth.Auth.AppUpdateOrCreate:output_type -> base.Empty
	5, // 9: auth.Auth.AppDelete:output_type -> base.Empty
	2, // 10: auth.Auth.AppReset:output_type -> auth.AppResetResp
